...
var Pokemon_array = [
    ...
    [
      ...
      //#FIXME: Male and Female have different egg moves... make sure to add that to the thread
        ...
        new Pokemon("Bonsly", 3, "ROCK", "NONE", "NONE",
            0.5, ["STURDY", "ROCK HEAD", "RATTLED"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Nosepass", 3, "ROCK", "NONE", "STEEL",
            0.5, ["STURDY", "MAGNET PULL", "SAND FORCE"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Rockruff", 3, "ROCK", "NONE", "NONE",
            0.5, ["KEEN EYE", "VITAL SPIRIT", "STEADFAST"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Roggenrola", 3, "ROCK", "NONE", "NONE",
            0.5, ["STURDY", "WEAK ARMOR", "SAND FORCE"],
            ["Egg Moves Unavailable"]),
      
        new Pokemon("Clamperl", 3, "WATER", "NONE", "NONE",
            0.5, ["SHELL ARMOR", "RATTLED"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Clauncher", 3, "WATER", "NONE", "NONE",
            0.5, ["MEGA LAUNCHER"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Corphish", 3, "WATER", "NONE", "DARK",
            0.5, ["HYPER CUTTER", "SHELL ARMOR", "ADAPTABILITY"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Feebas", 3, "WATER", "NONE", "NONE",
            0.5, ["SWIFT SWIM", "OBLIVIOUS", "ADAPTABILITY"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Froakie", 3, "WATER", "NONE", "DARK",
            0.125, ["TORRENT", "PROTEAN"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Magikarp", 3, "WATER", "NONE", "FLYING",
            0.5, ["SWIFT SWIM", "RATTLED"],
            ["Egg Moves Unavailable"]),
      //#FIXME: Should it also have Dark added in there for the mega-evo?
      
        new Pokemon("Mudkip", 3, "WATER", "NONE", "GROUND",
            0.125, ["TORRENT", "DAMP"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Psyduck", 3, "WATER", "NONE", "NONE",
            0.5, ["DAMP", "CLOUD NINE", "SWIFT SWIM"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Remoraid", 3, "WATER", "NONE", "NONE",
            0.5, ["HUSTLE", "SNIPER", "MOODY"],
            ["Egg Moves Unavailable"]),
        new Pokemon("Seel", 3, "WATER", "NONE", "ICE",
            0.5, ["THICK FAT", "HYDRATION", "ICE BODY"],
            ["Egg Moves Unavailable"]),
        ...
        new Pokemon("Staryu", 3, "WATER", "NONE", "PSYCHIC",
            0.5, ["ILLUMINATE", "NATURAL CURE", "ANALYTIC"],
            ["Egg Moves Unavailable"]),
      //#FIXME: Should be Genderless ideally
      
        new Pokemon("Totodile", 3, "WATER", "NONE", "NONE",
            0.125, ["TORRENT", "SHEER FORCE"],
            ["Egg Moves Unavailable"])          
    ],
    //rarity 4
    [
        new Pokemon("Endang", 4, "NONE", "NONE", "NONE",
            0.5, ["N/A"],
            ["N/A"]),
        new Pokemon("Name", 4, "NONE", "NONE", "NONE",
            0.5, ["N/A"],
            ["N/A"]),
        new Pokemon("Name", 4, "NONE", "NONE", "NONE",
            0.5, ["N/A"],
